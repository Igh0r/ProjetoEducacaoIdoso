...
class AppTheme {
  ...
  static ThemeData fromAccessibility(AccessibilitySettings settings) {
    ...
    return _buildTheme(settings, background: _bg, panel: _panel, accent: settings.highContrast ? _line : Colors.amber.shade400, highContrast: settings.highContrast);
  }
  ...
  static ThemeData _buildTheme(
    ...
    final textColor = highContrast ? Colors.white : _muted;
