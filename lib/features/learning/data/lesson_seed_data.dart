...
final categories = <LessonCategory>[
  LessonCategory('technology', 'Tecnologia', '💻', Colors.blue, 'Aprenda a usar celular, WhatsApp e internet', [
    ...
    Lesson(id: 'tech-2', title: 'Fazendo videochamadas', description: 'Veja a família de qualquer lugar', emoji: '📹', duration: '6 min', difficulty: 'Fácil', minutes: 6, steps: const [LessonStep('Escolha um contato', 'Abra o aplicativo de conversa e toque no nome da pessoa.', '👥'), LessonStep('Toque na câmera', 'Procure o ícone de câmera de vídeo e toque uma vez.', '📹', tip: 'Use Wi-Fi para melhorar a chamada.'), LessonStep('Fale em local claro', 'Aproxime o celular do rosto e procure um lugar iluminado.', '💡')], quiz: const [QuizQuestion('Qual ícone costuma iniciar videochamada?', ['Câmera de vídeo', 'Lixeira', 'Carrinho'], 0, 'O ícone de câmera inicia chamadas com imagem.'), QuizQuestion('O que ajuda a chamada ficar melhor?', ['Wi-Fi e local claro', 'Tela desligada', 'Volume mudo sempre'], 0, 'Boa conexão e iluminação facilitam a conversa.')]),
    Lesson(
    ...
    Lesson(id: 'tech-5', title: 'Usando o YouTube', description: 'Assista vídeos, receitas e novelas', emoji: '▶️', duration: '8 min', difficulty: 'Fácil', minutes: 8, steps: const [LessonStep('Abra o YouTube', 'Toque no ícone vermelho com botão de play.', '▶️'), LessonStep('Pesquise com palavras simples', 'Toque na lupa e escreva o tema, como receita, música ou exercício leve.', '🔎'), LessonStep('Cuidado com anúncios', 'Não clique em promessas de prêmio ou dinheiro fácil.', '🛡️', warning: 'Desconfie de vídeos que pedem dados pessoais ou pagamento fora de canais oficiais.')], quiz: const [QuizQuestion('Como procurar um vídeo?', ['Tocando na lupa', 'Apagando o app', 'Ligando para emergência'], 0, 'A lupa abre a busca por vídeos.'), QuizQuestion('O que fazer com promessa de prêmio?', ['Desconfiar e não informar dados', 'Enviar senha', 'Pagar rápido'], 0, 'Promessas exageradas podem ser golpe.')]),
    Lesson(id: 'tech-6', title: 'Usando o Google Maps', description: 'Encontre endereços e trace rotas', emoji: '🗺️', duration: '8 min', difficulty: 'Fácil', minutes: 8, steps: const [LessonStep('Digite o destino', 'Abra o mapa e escreva o endereço ou nome do local.', '🗺️'), LessonStep('Escolha a rota', 'Veja opções de carro, ônibus ou a pé antes de sair.', '🚌'), LessonStep('Compartilhe com confiança', 'Se precisar, compartilhe sua localização apenas com familiar ou cuidador de confiança.', '📍', warning: 'Evite compartilhar localização com desconhecidos.')], quiz: const [QuizQuestion('O que digitar no mapa?', ['Endereço ou nome do local', 'Senha do banco', 'Código SMS'], 0, 'O mapa usa endereço ou nome do destino.'), QuizQuestion('Com quem compartilhar localização?', ['Pessoa de confiança', 'Desconhecidos', 'Grupo público'], 0, 'Localização é informação pessoal.')]),
  ]),
  LessonCategory('health', 'Saúde', '❤️', Colors.red, 'Cuide melhor da sua saúde e bem-estar', [
    ...
    Lesson(id: 'health-5', title: 'Em caso de emergência', description: 'O que fazer e quem chamar', emoji: '🚑', duration: '7 min', difficulty: 'Fácil', minutes: 7, steps: const [LessonStep('Mantenha a calma', 'Respire e procure um local seguro antes de agir.', '🧘'), LessonStep('Ligue para o serviço correto', 'SAMU 192, Bombeiros 193, Polícia 190 e CVV 188.', '☎️'), LessonStep('Informe o essencial', 'Diga endereço, o que aconteceu e se há risco imediato.', '📍', warning: 'Em risco imediato, ligue para emergência; não espere resposta por aplicativo.')], quiz: const [QuizQuestion('Qual número do SAMU?', ['192', '193', '190'], 0, 'SAMU atende urgências de saúde pelo 192.'), QuizQuestion('O que informar na ligação?', ['Endereço e o que aconteceu', 'Senha do celular', 'Dados do banco'], 0, 'Local e situação ajudam o atendimento.')]),
  ]),
  ...
  LessonCategory('citizenship', 'Cidadania Digital', '🏛️', Colors.amber, 'INSS, gov.br, SUS e seus direitos', [
    Lesson(id: 'citizen-1', title: 'Consultar INSS pelo celular', description: 'Veja seu extrato e benefícios no Meu INSS', emoji: '📋', duration: '10 min', difficulty: 'Médio', minutes: 10, steps: const [LessonStep('Use o Meu INSS oficial', 'Abra o aplicativo Meu INSS ou acesse pelo gov.br.', '📋'), LessonStep('Entre com gov.br', 'Use CPF e senha no canal oficial.', '🏛️', warning: 'Não entregue senha do gov.br para terceiros.'), LessonStep('Procure extratos e benefícios', 'Leia a tela com calma e salve comprovantes importantes.', '🧾')], quiz: const [QuizQuestion('Como entrar no Meu INSS?', ['Com gov.br oficial', 'Por link desconhecido', 'Por senha de outra pessoa'], 0, 'O acesso deve ser feito pelo gov.br oficial.'), QuizQuestion('Senha gov.br deve ser:', ['Pessoal e protegida', 'Compartilhada em grupo', 'Enviada por SMS'], 0, 'Senha é pessoal.')]),
    ...
    Lesson(id: 'citizen-3', title: 'SUS: Agendamento online', description: 'Agende consultas e exames pela internet', emoji: '🏥', duration: '8 min', difficulty: 'Médio', minutes: 8, steps: const [LessonStep('Confira o canal da cidade', 'Use aplicativo, site ou unidade de saúde indicado pela prefeitura.', '🏥'), LessonStep('Tenha documentos à mão', 'Separe CPF, Cartão SUS e informações do pedido médico, se houver.', '🪪'), LessonStep('Anote data e local', 'Depois de agendar, salve ou escreva horário, endereço e preparo.', '📝')], quiz: const [QuizQuestion('Quais dados podem ser úteis no SUS?', ['CPF e Cartão SUS', 'Senha do banco', 'Código de cartão'], 0, 'Documentos ajudam a localizar cadastro.'), QuizQuestion('Depois de agendar, o que anotar?', ['Data, horário e local', 'Senha do vizinho', 'Nada'], 0, 'Anotar evita esquecimentos.')]),
    Lesson(id: 'citizen-4', title: 'Imposto de Renda simplificado', description: 'Entenda e declare o IR pelo celular', emoji: '🧾', duration: '12 min', difficulty: 'Difícil', minutes: 12, steps: const [LessonStep('Separe documentos', 'Tenha informes de rendimentos, recibos e documentos pessoais.', '📄'), LessonStep('Use canais oficiais', 'A declaração deve ser feita por programa, aplicativo ou site oficial da Receita Federal.', '🧾', warning: 'Cuidado com links prometendo restituição imediata.'), LessonStep('Peça ajuda qualificada', 'Se tiver dúvida, procure contador, familiar confiável ou canal oficial.', '🤝')], quiz: const [QuizQuestion('Onde declarar com segurança?', ['Canal oficial da Receita', 'Link de promessa de prêmio', 'Mensagem anônima'], 0, 'Use canais oficiais.'), QuizQuestion('Se tiver dúvida no IR, o ideal é:', ['Buscar ajuda qualificada', 'Chutar valores', 'Enviar senha'], 0, 'Apoio qualificado reduz erros.')]),
    Lesson(
  ...
  LessonCategory('finance', 'Finanças', '💰', Colors.teal, 'Cuide do dinheiro e conheça seus direitos', [
    ...
    Lesson(id: 'finance-3', title: 'Crédito consignado', description: 'Entenda antes de assinar qualquer contrato', emoji: '📄', duration: '8 min', difficulty: 'Fácil', minutes: 8, steps: const [LessonStep('Entenda o desconto', 'Consignado é descontado direto do benefício ou salário.', '💰'), LessonStep('Leia o contrato', 'Confira valor total, parcelas, juros e prazo antes de aceitar.', '📄', warning: 'Nunca contrate por pressão ou sem ler as condições.'), LessonStep('Compare antes de decidir', 'Converse com alguém de confiança e compare ofertas oficiais.', '🔎')], quiz: const [QuizQuestion('O consignado é descontado de onde?', ['Benefício ou salário', 'Do tempo de tela', 'Da bateria'], 0, 'O desconto costuma ser automático.'), QuizQuestion('Antes de assinar, é importante:', ['Ler juros, parcelas e prazo', 'Aceitar rápido', 'Ignorar contrato'], 0, 'Entender o contrato protege seu dinheiro.')]),
  ]),
];
